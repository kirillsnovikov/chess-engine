...
export const BASE_SQUARE_SET: Square[] = [
  ...
  new Square(ChessCellSet.findCellById('b1'), new Bishop(whitePieceColor)),
  new Square(ChessCellSet.findCellById('c1'), new Knight(whitePieceColor)),
  ...
  new Square(ChessCellSet.findCellById('b8'), new Bishop(blackPieceColor)),
  new Square(ChessCellSet.findCellById('c8'), new Knight(blackPieceColor)),
